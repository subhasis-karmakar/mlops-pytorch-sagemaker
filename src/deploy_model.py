...
MODEL_NAME = "pytorch-mlops-registered-model"
ENDPOINT_CONFIG_NAME = "pytorch-mlops-endpoint-config"
...
# Optional selectors
MODEL_PACKAGE_ARN = None          # e.g. "arn:aws:sagemaker:...:model-package/..."
MODEL_VERSION = None              # e.g. 3
ONLY_APPROVED = True
...
def resolve_model_package_arn() -> str:
    ...
    if MODEL_VERSION is not None:
        return get_model_package_by_version(MODEL_PACKAGE_GROUP_NAME, MODEL_VERSION)
